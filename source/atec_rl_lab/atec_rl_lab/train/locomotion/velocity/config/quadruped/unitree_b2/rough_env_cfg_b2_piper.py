...
class UnitreeB2PiperRoughEnvCfg(LocomotionVelocityRoughEnvCfg):
    ...
    def __post_init__(self):
        ...
        self.observations.critic.joint_vel.params["asset_cfg"].joint_names = self.leg_joint_names
        ...
        # Arm perturbation: randomize arm joint targets at intervals to simulate
        # arm movement during locomotion, forcing the policy to be robust.
        self.events.randomize_arm_joint_targets = EventTerm(
